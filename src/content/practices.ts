...
/**
 * The four practice areas shown on /what-we-do. Anchors (`id`) must match the
 * service links in src/lib/site.ts. Edit the prose here.
 */
...
export const procurementVehicles: { name: string; detail: string }[] = [
  ...
  { name: 'Digital Outcomes 6', detail: 'Multidisciplinary teams to deliver digital outcomes.' },
  {
    ...
    detail: 'Risk assessment, assurance and security testing services.',
  },
  { name: 'Spark DPS', detail: 'The technology innovation marketplace for emerging tech.' },
]
